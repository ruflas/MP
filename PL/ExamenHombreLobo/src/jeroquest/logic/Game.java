...
public class Game {
	...
	public Game(int numHeroes, int numMonsters, int rows, int columns, int totalRounds) {
		...
		// create the characters
		 characters = new Character[numHeroes + numMonsters+2];
		...
		characters[characters.length-1] = new Werewolf("Werewolf"+2, "xd");
		characters[characters.length-2] = new Werewolf("Werewolf"+1, "xd");
		// first round
		currentRound = 1;
	}
